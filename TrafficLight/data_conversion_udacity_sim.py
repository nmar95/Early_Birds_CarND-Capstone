...
def create_tf_example(example):
    ...
    for box in example['annotations']:
        ...
        #print("adding box")
        xmins.append(float(box['xmin'] * 1.0/ width))
        xmaxs.append(float((box['xmin'] + box['x_width']) * 1.0/ width))
        ymins.append(float(box['ymin'] * 1.0/ height))
        ymaxs.append(float((box['ymin']+ box['y_height']) * 1.0/ height))
...
def main(_):
    ...
    for example in examples:
        ...
        if counter % 10 == 0:
            print("Percent done", (counter * 1.0/len_examples * 1.0)*100.0)
        counter += 1
